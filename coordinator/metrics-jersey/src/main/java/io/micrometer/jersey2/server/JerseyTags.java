...
/**
 * Factory methods for {@link Tag Tags} associated with a request-response exchange that is handled
 * by Jersey 2.
 *
...
public final class JerseyTags {
  ...
  /**
   * Creates a {@code method} tag based on the {@link ContainerRequest#getMethod() method} of the
   * given {@code request}.
   */
  ...
  /**
   * Creates a {@code uri} tag based on the URI of the given {@code event}. Uses the {@link
   * ExtendedUriInfo#getMatchedTemplates()} if available. {@code REDIRECTION} for 3xx responses,
   * {@code NOT_FOUND} for 404 responses.
   */
  ...
  /**
   * Creates a {@code exception} tag based on the simple name of the class of the given {@code
   * exception}.
   */
