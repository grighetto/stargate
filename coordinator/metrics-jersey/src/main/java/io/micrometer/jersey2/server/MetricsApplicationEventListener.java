...
/**
 * The Micrometer {@link ApplicationEventListener} which registers {@link RequestEventListener} for
 * instrumenting Jersey server requests.
 *
...
public class MetricsApplicationEventListener implements ApplicationEventListener {
  ...
  public MetricsApplicationEventListener(
  ...
  public RequestEventListener onRequest(RequestEvent requestEvent) {
    return new MetricsRequestEventListener(
